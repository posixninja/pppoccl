...
enum {
    ...
    PPP_OPT_DEV_NAME = 1,		// string //1
    PPP_OPT_DEV_SPEED,			// 4 bytes //2
    PPP_OPT_DEV_CONNECTSCRIPT,		// string //3
    
    PPP_OPT_COMM_IDLETIMER,		// 4 bytes //4
    PPP_OPT_COMM_REMOTEADDR,		// string //5

    PPP_OPT_AUTH_PROTO,			// 4 bytes //6
    PPP_OPT_AUTH_NAME,			// string //7
    PPP_OPT_AUTH_PASSWD,		// string //8

    PPP_OPT_LCP_HDRCOMP,		// 4 bytes //9
    PPP_OPT_LCP_MRU,			// 4 bytes //10
    PPP_OPT_LCP_MTU,			// 4 bytes //11
    PPP_OPT_LCP_RCACCM,			// 4 bytes //12
    PPP_OPT_LCP_TXACCM,			// 4 bytes //13

    PPP_OPT_IPCP_HDRCOMP,		// 4 bytes //14
    PPP_OPT_IPCP_LOCALADDR,		// 4 bytes //15
    PPP_OPT_IPCP_REMOTEADDR,		// 4 bytes //16

    PPP_OPT_LOGFILE,			// string //17
    PPP_OPT_RESERVED,			// 4 bytes //18
    PPP_OPT_COMM_REMINDERTIMER,		// 4 bytes //19
    PPP_OPT_ALERTENABLE,		// 4 bytes //20

    PPP_OPT_LCP_ECHO,			// struct ppp_opt_echo //21

    PPP_OPT_COMM_CONNECTDELAY,		// 4 bytes //22
    PPP_OPT_COMM_SESSIONTIMER,		// 4 bytes //23
    PPP_OPT_COMM_TERMINALMODE,		// 4 bytes //24
    PPP_OPT_COMM_TERMINALSCRIPT,	// string. Additionnal connection script, once modem is connected //25
    PPP_OPT_RESERVED1,			// place holder //26

    PPP_OPT_RESERVED2,			// place holder //27
    PPP_OPT_DEV_CONNECTSPEED,		// 4 bytes, actual connection speed //28
    PPP_OPT_SERVICEID,			// string, name of the associated service in the cache //29
    PPP_OPT_IFNAME,			// string, name of the associated interface (ppp0, ...) //30
    
    PPP_OPT_DEV_DIALMODE,		// 4 bytes, dial mode, applies to modem connection //31
    PPP_OPT_DIALONDEMAND		// 4 bytes, is service configured for DialOnDemand ? //32
};
